    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(
                auth -> auth.requestMatchers("/signin", "/signup").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/appointment_cancels/**").hasAnyRole("ADMIN", "USER")
                        .requestMatchers(HttpMethod.POST, "/api/v1/appointment_cancels/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/appointment_cancels/**").hasRole("ADMIN")
